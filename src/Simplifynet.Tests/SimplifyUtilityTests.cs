...
using SimplifyDotnet.Tests;

namespace Simplifynet.Tests
{
    [TestFixture]
    public class SimplifyUtilityTests
    {
        ...
        public void SimplifyTimings(ISimplifyUtility utility)
        {
            ...
            var firstRun3D = utility.Simplify(points);
            watch.Stop();
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    watch = Stopwatch.StartNew();
                    var run = utility.Simplify(points);
                    watch.Stop();
        ...
        [Test]
        public void SimplifyWithMultiplePointsShouldSimplfyCorrectly()
        {
            SimplifyWithMultiplePointsShouldSimplfyCorrectly(new SimplifyUtility());
        }

        [Test]
        public void Simplify3DWithMultiplePointsShouldSimplfyCorrectly()
        {
            SimplifyWithMultiplePointsShouldSimplfyCorrectly(new SimplifyUtility3D());
        }

        public void SimplifyWithMultiplePointsShouldSimplfyCorrectly(ISimplifyUtility utility)
        {
            var points = new[] {
        ...
        [Test]
        public void SimplifySinglePointResultSholdOnlyContainSinglePoint()
        {
            SimplifySinglePointResultSholdOnlyContainSinglePoint(new SimplifyUtility());
        }

        [Test]
        public void Simplify3DSinglePointResultSholdOnlyContainSinglePoint()
        {
            SimplifySinglePointResultSholdOnlyContainSinglePoint(new SimplifyUtility3D());
        }

        public void SimplifySinglePointResultSholdOnlyContainSinglePoint(ISimplifyUtility utility)
        {
        ...
        [Test]
        public void SimplifyWithEmptyArraySholdShouldReturnEmptyList()
        {
            SimplifyWithEmptyArraySholdShouldReturnEmptyList(new SimplifyUtility());
        }

        [Test]
        public void Simplify3DWithEmptyArraySholdShouldReturnEmptyList()
        {
            SimplifyWithEmptyArraySholdShouldReturnEmptyList(new SimplifyUtility3D());
        }

        public void SimplifyWithEmptyArraySholdShouldReturnEmptyList(ISimplifyUtility utility)
        {
            var result = utility.Simplify(new Point[0]);
