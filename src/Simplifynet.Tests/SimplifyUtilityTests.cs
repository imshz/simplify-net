...
namespace Simplifynet.Tests
{
    ...
    public class SimplifyUtilityTests
    {
        ...
        public void Simplify2DTimings()
        {
            ...
            var firstRun3D = SimplifyUtility.Simplify(points);
            watch.Stop();
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    watch = Stopwatch.StartNew();
                    var run = SimplifyUtility.Simplify(points);
                    watch.Stop();
        ...
        public void Simplify3DTimings()
        {
            ...
            watch = Stopwatch.StartNew();
            var firstRun3D = SimplifyUtility3D.Simplify(points);
            watch.Stop();
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    watch = Stopwatch.StartNew();
                    var run = SimplifyUtility3D.Simplify(points);
                    watch.Stop();
                    totalTime += watch.ElapsedTicks;
                }
        ...
        public void SimplifyWithMultiplePointsShouldSimplfyCorrectly()
        {
            ...
            var result = SimplifyUtility.Simplify(points, 5, false);
        ...
        public void SimplifySinglePointResultSholdOnlyContainSinglePoint()
        {
            ...
            var result = SimplifyUtility.Simplify(new[] { Point });
        ...
        {
            var result = SimplifyUtility.Simplify(new Point[0]);
        ...
        public void Simplify3DWithMultiplePointsShouldSimplfyCorrectly()
        {
            ...
            var result = SimplifyUtility3D.Simplify(points, 5, false);
        ...
        {
            var Point = new Point(224.55, 250.15);
            var result = SimplifyUtility3D.Simplify(new[] { Point });
        ...
        {
            var result = SimplifyUtility3D.Simplify(new Point[0]);
